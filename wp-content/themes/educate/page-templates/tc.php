...
<div class="educate-container container">
	<div class="home-page-blog">
		<div class="title-box">
			<h2 class="content-heading"> <span> TC </span> </h2>
		</div>
		...
		if ($educate_loop->have_posts()) : while ($educate_loop->have_posts()) : $educate_loop->the_post();
				...
				$meta_val = get_post_meta(get_the_ID());
				?>
				<?php if ($educate_image[0] != "") { $i = $i + 1;  ?>
				<div class="col-md-4">
					<div class="view-box item">
						<div class="view-effect"> 
						<a href="javascript:;">
						<img alt="<?php esc_attr(the_title()); ?>" src="<?php echo esc_url($educate_image[0]); ?>" class="img-responsive">
						</a>
							<div class="view-hover-effect"> <a href="javascript:;" class="hover-icon"> <i class="fa fa-arrows"></i> </a> </div>
						</div>
						<div class="blog-discription row">
							<div class="col-md-12 col-sm-12 blog-title">
								<?php echo $meta_val['student_name'][0]; ?>
								<br/>
								<?php echo $meta_val['student_class'][0]; ?>
								<br/>
								<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'single-post-thumbnail' ); ?>
								<a href="<?php echo esc_url($image[0]); ?>" download>Download</a>
							</div>
						</div>
					</div>
				</div>
