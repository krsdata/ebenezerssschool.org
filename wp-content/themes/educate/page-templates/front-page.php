...
<section>
    <div id="educatecarousel" class="carousel slide educate-slider" data-interval="3000" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            for ($educate_loop = 0; $educate_loop < 9; $educate_loop++):
                ?>
                <?php
                if (!empty($educate_options['slider-img-' . $educate_loop])) {
                    ...
                    <div class="item<?php echo $educate_class; ?>">
                        <img src="<?php echo esc_url($educate_options['slider-img-' . $educate_loop]); ?>"  width="<?php echo $educate_image[0]; ?>" height="<?php echo $educate_image[1]; ?>" alt="<?php echo $educate_loop; ?>">
    ...
    <?php }
    ?>
	<?php echo do_shortcode('[horizontal_news category="news"]'); ?>
    <?php
